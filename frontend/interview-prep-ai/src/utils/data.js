...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers based on your role, experience, and specific focus areas — no generic prep, only what matters to you."
  },
  {
    id: "02",
  ...
  {
    id: "05",
    title: "Easily Save Your Interview Sets",
    description:
      "Save complete interview question sets, organize them by role or topic, and revisit them anytime for quick and focused revision."
  }
];
